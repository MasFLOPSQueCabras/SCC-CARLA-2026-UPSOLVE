...
from scc_provider_helvetios.bios import BiosProfile, get_profile_attributes
...
class HelvetiosProvider(NodeProvider):
    ...
    def __init__(
        ...
        if settings is not None:
            ...
            state_db = Path.home() / ".config" / "scc_carla" / "state.db"
