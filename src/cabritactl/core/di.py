...
class ProviderNotInstalledError(RuntimeError):
    ...
    def __init__(self, provider: str, reason: str | None = None) -> None:
        ...
        hint = (
            f"uv tool install 'cabritactl[{canonical}]'"
...
class ProviderRegistry:
    ...
    def _discover_entry_points(self) -> None:
        ...
        for entry in importlib.metadata.entry_points(group="cabritactl.providers"):
...
def create_registry() -> ProviderRegistry:
    ...
    registry.register_lazy(
        ...
        module_path="cabritactl.providers.libvirt_backend.provider",
        class_name="LibvirtProvider",
    )
    registry.register_lazy(
        name=ProviderType.HELVETIOS.value,
        module_path="cabritactl.providers.helvetios.provider",
