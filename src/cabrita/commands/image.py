...
from cabrita.bootstrap.artifacts import artifact_lock
from cabrita.bootstrap.golden import capture
from cabrita.commands.workflow import ClusterOption, service_context
from cabrita.core.image import inspect_image
from cabrita.core.providers.base import PowerState
from cabrita.paths import get_golden_image_dir
        ...
        with service_context(cluster) as service:
            ...
            with service.locks.acquire(
                ...
                if provider.get_power_status(node) != PowerState.OFF:
                    raise ValueError(
                        "Shut down the node with cabrita down before capture"
                    )
