...
from cabrita.db import LockError, NodeLifecycle, update_node_state
from cabrita.nodes import resolve_target_nodes
from cabrita.ops import cluster_lock, wait_for_power_state
from cabrita.providers.base import NodeProvider, PowerState
        ...
        with (
            ...
            if len(targets) == 1:
                ...
                runner = ParallelRunner[int, bool](
                    ...
                    thread_name_prefix="cabrita-power",
                )
